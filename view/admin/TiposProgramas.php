                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><i class="fa fa-book"></i> Tipos de Programas</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="text-center">
                            <a href="#" class="btn btn-default" onclick="frmNuevoTipoPrograma();return false;">Nuevo</a>
                        </div>
                        <br>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-3 col-md-6 col-md-offset-3">
                            <h2 class="text-center">Tipos de Programas</h2>
