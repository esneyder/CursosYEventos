                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li class="active"><i class="fa fa-group"></i> Requisitos</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="text-center">
                            <a href="#" class="btn btn-default" onclick="frmNuevoRequisito();return false;">Nuevo</a>
                        </div>
                        <br>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-1 col-md-10 col-md-offset-1">
                            <h2 class="text-center">Gestión de Requisitos</h2>
