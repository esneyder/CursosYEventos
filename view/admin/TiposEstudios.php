                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <ol class="breadcrumb">
                                ...
                                <li><i class="fa fa-bars"></i><a href="#"> Maestras</a></li>
                                <li class="active"><i class="fa fa-book"></i> Tipos de Estudios</li>
                            </ol>
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="text-center">
                            <a href="#" class="btn btn-default" onclick="frmNuevoTipoEstudio();return false;">Nuevo</a>
                        </div>
                        <br>
                        ...
                        <div class="alertas text-center col-xs-12 col-md-offset-1 col-md-10 col-md-offset-1">
                        </div>
                    </div>
                    <!-- /.row -->
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-offset-3 col-md-6 col-md-offset-3">
                            <h2 class="text-center">Tipos de Estudios</h2>
